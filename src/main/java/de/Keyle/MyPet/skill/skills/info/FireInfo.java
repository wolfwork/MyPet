...
public class FireInfo extends MyPetSkillTreeSkill implements ISkillInfo, Serializable
{
    ...
    public String getHtml()
    {
        ...
        {
            int change = ((IntTag) getProperties().getValue().get("chance")).getValue();
            html = html.replace("chance\" value=\"0\"", "chance\" value=\"" + change + "\"");
